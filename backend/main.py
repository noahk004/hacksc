...
elements = []
url = "https://d924-99-61-94-237.ngrok-free.app/generate"
        ...
        "messages": [
            {
                ...
                if they want to input something, you return a dictionary with this format:{'action': 'input', 'input_name': 'username', 'text_value': 'projecthackdemo'}, or {'action': 'input', 'input_name': 'password', 'text_value': 'hackathon'}
